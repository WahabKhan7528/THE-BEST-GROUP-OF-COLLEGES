...
export default function PortalPageHeader({ title, subtitle, badge, action, className }) {
    return (
        <div className={clsx(
            "relative bg-white dark:bg-college-navy border border-gray-200 dark:border-college-gold/30 rounded-2xl p-4 sm:p-6 md:p-8 lg:p-10 shadow-2xl overflow-hidden transition-colors duration-300",
            className
        )}>
                ...
                <div className="flex gap-4 md:gap-8">
                    ...
                    <div className="space-y-3 md:space-y-4">
                        ...
                        <div className="flex flex-nowrap items-center gap-2 md:gap-3">
                            <span className="text-[10px] md:text-xs font-black text-college-navy dark:text-college-gold uppercase tracking-[0.3em] leading-none flex items-center gap-2 whitespace-nowrap">
                                Institutional Portal
                                {badge && <div className="h-1 w-1 rounded-full bg-college-navy dark:bg-college-gold" />}
                                {badge && (
