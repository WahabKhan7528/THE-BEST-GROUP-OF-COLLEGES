...
const Admissions = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      >
        <PublicButton to="tel:+92511234567" variant="secondary" size="md"  shape="slanted">
          Call Us: +92 51 1234 567
        </PublicButton>
        <PublicButton to="mailto:admissions@bestcolleges.edu.pk" variant="outline" size="md" className="border-2 border-white/20" shape="slanted">
