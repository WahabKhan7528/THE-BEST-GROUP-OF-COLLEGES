...
const variants = {
  ...
  outline:
    "bg-transparent text-college-navy dark:text-white border border-college-navy dark:border-white/30",
  subtle:
    "bg-gray-100 dark:bg-dark-elevated text-college-navy dark:text-white/80",
  success:
