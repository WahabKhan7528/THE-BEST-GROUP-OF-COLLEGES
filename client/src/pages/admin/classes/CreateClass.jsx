      ...
      <PortalForm.Section title="Campus Allocation" className="!space-y-4">
        <div className="col-span-1 md:col-span-2">
          ...
          {isSuperAdmin ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
              {campuses.map((campus) => (
                <label
                  key={campus.id}
                  className={`
                    relative flex flex-col items-center justify-center p-6 rounded-sm border-2 cursor-pointer transition-all duration-200
            ...
            <div className="flex items-center gap-3 p-4 bg-gray-50 border border-gray-200 dark:bg-college-navy/50 dark:border-college-gold/20 rounded-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="col-span-1 md:col-span-2">
          ...
          <div className="relative">
            <textarea
              ...
              rows="3"
              className="w-full pr-4 py-3.5 bg-gray-50/50 dark:bg-college-navy/50 border border-gray-200 dark:border-college-gold/20 rounded-sm focus:outline-none focus:ring-2 focus:ring-college-navy/20 dark:focus:ring-college-gold/20 focus:border-college-navy dark:focus:border-college-gold transition-all resize-none dark:text-white dark:placeholder-gray-500"
            />
          </div>
