...
const facilitiesData = [
  {
    ...
    description:
      "World-class learning environments designed to foster creativity and innovation.",
    items: [
      {
  ...
  },
  {
    ...
    badge: "Campus Life",
    description:
      "Ensuring a comfortable and holistic campus experience for every student.",
    items: [
      {
        name: "Cafeteria",
        description:
        ...
        image:
          "https://images.unsplash.com/photo-1567529684892-09290a1b2d05?auto=format&fit=crop&q=80&w=800",
      },
      {
        name: "Sports Complex",
        description:
      ...
      },
      {
        ...
        image:
          "https://images.unsplash.com/photo-1519494026892-50bb7a77a0cd?auto=format&fit=crop&q=80&w=800",
      },
      {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <SectionHeader
            ...
            title={
              <>
                World-Class{" "}
                <span className="text-college-gold">Facilities</span>
              </>
            }
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              {category.items.map((facility) => (
                <Card key={facility.name} className="group">
