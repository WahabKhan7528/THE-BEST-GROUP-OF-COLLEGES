  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <Section background="gray" spacing="large">
        <div key={activeTab} className="space-y-16">
          {/* News Section */}
          {showNews && (
            <div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {newsItems.slice(0, visibleNewsItems).map((news, idx) => (
                  ...
                  >
                    <Card
                      hover
                      className="h-full group border-l-4 border-l-primary-500 overflow-hidden outline-none focus:outline-none"
                    >
                      <div className="p-6 md:p-8 flex flex-col h-full bg-white relative">
                        ...
                        <div className="mt-auto z-10 border-t border-gray-100 pt-5">
                          <Button
                            ...
                            onClick={() =>
                              setSelectedItem({ ...news, type: "news" })
                            }
                          >
                            Read Full Story
              ...
              {visibleNewsItems < newsItems.length && (
                <div className="mt-12 flex justify-center">
                  <Button
                    variant="outline"
                    className="border-2 font-bold px-8 py-3 outline-none focus:outline-none active:outline-none"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {events.slice(0, visibleEventItems).map((event, idx) => (
                  ...
                  >
                    <Card
                      hover
                      className="overflow-hidden group flex flex-col sm:flex-row h-full outline-none focus:outline-none"
                    >
                      {/* High-Impact Date Block */}
                      <div
                        className={`sm:w-40 bg-gradient-to-br ${event.categoryColor} p-6 flex flex-row sm:flex-col items-center justify-center text-white gap-3 sm:gap-1 flex-shrink-0`}
                      >
                      ...
                      <div className="p-6 md:p-8 flex flex-col flex-grow bg-white">
                        ...
                        <div className="mt-auto">
                          <Button
                            variant="outline"
                            className="w-full sm:w-auto font-bold border-2 focus:outline-none focus:ring-0 focus:border-primary-600"
                            onClick={() =>
      ...
      {selectedItem && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-3xl max-h-[90vh] bg-white rounded-3xl shadow-2xl overflow-y-auto z-10">
            <button
              onClick={() => setSelectedItem(null)}
              ...
              {selectedItem.type === "event" && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 text-sm text-gray-700 font-medium bg-gray-50 p-6 rounded-2xl border border-gray-100">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="truncate" title={selectedItem.location}>
