...
const FacultyLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 flex flex-col lg:flex-row bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-purple-100/50 via-gray-50 to-gray-50">
      {/* Mobile Overlay */}
      {isSidebarOpen && (
        <div
      ...
      >
        <div className="flex items-center justify-between px-6 h-20 border-b border-gray-100/50">
          <div>
            <p className="text-xs font-semibold text-purple-600 uppercase tracking-wider mb-0.5">Faculty Portal</p>
          ...
          <div className="h-full flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="hidden lg:block">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-purple-50 text-purple-700 ring-1 ring-inset ring-purple-600/20">
                  <User size={12} />
                  Faculty Panel
                </span>
              </div>
