  ...
  return (
    <Card className="h-full relative overflow-hidden border border-border" hover>
      ...
      <div className="flex flex-col h-full relative z-10">
        {/* Quote Icon */}
        <div className="mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary-100 text-primary-600">
        ...
        {/* Content */}
        <p className="text-text-secondary flex-grow mb-6 leading-relaxed italic">
          "{content}"
        </p>
        ...
        <div className="flex items-center pt-4 border-t border-border">
          ...
          <div className="ml-4">
            <h4 className="text-xl font-bold text-primary-900 mb-1">{name}</h4>
