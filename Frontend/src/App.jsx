          ...
          <Router>
            <Routes>
              ...
              <Route path="/admin" element={<AdminLayout />}>
                ...
                <Route
                  path="campus/:campusId/allocate-admin"
                  element={<AllocateAdmin />}
                />
